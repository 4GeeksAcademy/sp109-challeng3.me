...
import foto2 from "../assets/img/foto-programacion.png"
import foto3 from "../assets/img/collage-de-fondo-de-programacion(1).jpg"
            ...
            <div className="container py-5">
                <div className="row">
                    <div className="col-lg-12">
                        <div className="text-center">
                            ...
                            <h3 className="" _msttexthash="973349" _msthash="301">Sobre <span className="text-danger" _istranslated="1">Nosotros</span></h3>
                ...
                <div className="mt-2 py-5 align-items-center row">
                    <div className="col-lg-5 col-md-6">
                        <img src={foto2} alt="foto2" className="img-fluid rounded-circle img-thumbnail" />
                    </div>
                ...
                <div className="pb-3 pt-5 align-items-center row">
                    ...
                    <div className="col-lg-5 col-md-6 offset-md-1">
                        <img src={foto3} alt="foto2" className="img-fluid rounded-circle img-thumbnail" />
                    </div>
                </div>
            </div>
        </div>
